...
public class AddMedicine extends AppCompatActivity {
    ...
    private static final String CLOUD_VISION_API_KEY = "AIzaSyARFjZEcY-IJ0J0wbFPZ4LdPfG0AHs-Zk4";
    ...
    private static final String TAG = AddMedicine.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("薬を登録");
        imageView = findViewById(R.id.image_view);
        textView = findViewById(R.id.OCRString);
    ...
    public void startGalleryChooser() {
        Log.d("click", "startGalleryChooser: ");
    ...
    private static class LableDetectionTask extends AsyncTask<Object, Void, String> {
        private final WeakReference<AddMedicine> mActivityWeakReference;
        private Vision.Images.Annotate mRequest;

        LableDetectionTask(AddMedicine activity, Vision.Images.Annotate annotate) {
        ...
        protected void onPostExecute(String result) {
            AddMedicine activity = mActivityWeakReference.get();
            if (activity != null && !activity.isFinishing()) {
                TextView imageDetail = activity.findViewById(R.id.OCRString);
